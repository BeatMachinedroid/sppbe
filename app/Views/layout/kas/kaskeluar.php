...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder text-white mb-0 pt-2">List Kas Keluar</h6>
        </nav>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <form action="<?= base_url('/dashboard/kas/keluar/search') ?>" method="get"
                                id="search">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <button class="btn btn-primary btn-sm" data-toggle="modal"
                                                            data-target="#editbarang-<?= $item['id_kas_keluar'] ?>">
                                                    ...
                                                    <div class="modal fade"
                                                        id="editbarang-<?= $item['id_kas_keluar'] ?>" tabindex="-1"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header"
                                                                    ...
                                                                    <h5 class="modal-title" id="exampleModalLabel"
                                                                        style="color: white;">Edit Kas keluar
                                                                    </h5>
                                                                ...
                                                                <form
                                                                    action="<?= base_url('/dashboard/kas/keluar/edit/' . $item['id_kas_keluar']) ?>"
                                                                    method="post">
                                                                    <?= csrf_field() ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #5873fe;">
                    <h5 class="modal-title" id="exampleModalLabel" style="color: white;">Add Kas Keluar</h5>
