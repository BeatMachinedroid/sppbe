            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <form action="<?= base_url('/dashboard/penjualan/search') ?>" method="get" id="search">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <button class="btn btn-primary btn-sm" data-toggle="modal"
                                                            data-target="#editbarang-<?= $item['id_penjualan'] ?>">
                                                    ...
                                                    <?php }?>
                                                    <div class="modal fade" id="editbarang-<?= $item['id_penjualan'] ?>"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header"
                                                                    ...
                                                                    <h5 class="modal-title" id="exampleModalLabel"
                                                                        style="color: white;">Edit Penjualan</h5>
                                                                ...
                                                                <form
                                                                    action="<?= base_url('dashboard/penjualan/edit/' . $item['id_penjualan']) ?>"
                                                                    method="post">
                                                                    <?= csrf_field() ?>
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <label
                                                                                class="control-label">Customers</label>
                                                                            <select class="form-control"
                                                                                name="customer_id">
                                                                                <?php foreach ($customer as $item2): ?>
                                                                                <option
                                                                                    value="<?= $item2['id_customer'] ?>">
                                                                                    <?= $item2['nama_customer'] ?>
                                                                                </option>
                                                                                <?php endforeach; ?>
                                                                            </select>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                name="keterangan"
                                                                                value="<?= $item['keterangan_penjualan'] ?>"
                                                                                required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="control-label">Barang</label>
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Barang" name="barang"
                                                                                value="<?= $item['barang'] ?>"
                                                                                required>
                                                                        </div>
                                                                        <div class="form-group">
