            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-left text-uppercase text-xs font-weight-bolder">No</th>
                                                            <th class="text-center text-uppercase text-xs font-weight-bolder">Tanggal</th>
                                                            <th class="text-center text-uppercase text-xs font-weight-bolder">Barang</th>
                                                            <th class="text-center text-uppercase text-xs font-weight-bolder">Keterangan</th>
                                                            <th class="text-center text-uppercase text-xs font-weight-bolder">jumlah</th>
                                                            <th class="text-center text-uppercase text-xs font-weight-bolder">total</th>
                   ...
                   <?php } else {?>
                    <?php $no=1+(10*($page-1)); foreach ($pembelian as $item): ?>
                        <tr>
                                                                    ...
                                                                    <?php if (session()->get('role') == 'admin') {?>
                                                                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editbarang-<?= $item['id_pembelian'] ?>">
                                                                            <span
                                                                    ...
                                                                    <?php }?>
                                                                    <div class="modal fade" id="editbarang-<?= $item['id_pembelian'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header" style="background-color: #5873fe;">
                                                                                    <h5 class="modal-title" id="exampleModalLabel" style="color: white;">Edit Pembelian</h5>
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true"><i class="ti-close" style="color: white;"></i></span>
                                                                                    </button>
                                                                                </div>
                                                                                <form action="<?= base_url('dashboard/pembelian/edit/'.$item['id_pembelian']) ?>" method="post">
                                                                                <?= csrf_field(); ?>
                                            ...
                                            <input type="text" class="form-control" placeholder="Keterangan" name="keterangan" value="<?= $item['keterangan_pembelian']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Barang</label>
                                            <input type="text" class="form-control" placeholder="Keterangan" name="barang" value="<?= $item['barang']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                        <label class="control-label">Jumlah</label>
                                            <input type="number" class="form-control" placeholder="Jumlah" name="jumlah" value="<?= $item['jumlah']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                        <label class="control-label">Total</label>
                                            <input type="number" class="form-control" placeholder="total" name="total" value="<?= $item['total']; ?>" required>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="modal-header" style="background-color: #5873fe;">
                            ...
                            <form action="<?= base_url('/dashboard/pembelian/post'); ?>" method="post">
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Barang</label>
                                            <input type="text" class="form-control" placeholder="Keterangan" name="barang" required>
                                        </div>
                                        <div class="form-group">
                                        <label class="control-label">Jumlah</label>
